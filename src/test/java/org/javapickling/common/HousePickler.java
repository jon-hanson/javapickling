...
public class HousePickler<PF> extends ObjectPickler<House, PF> {
    ...
    public House unpickle(PF pf) throws IOException {
        ...
        final House.Type type = mu.field("type", pf, core.enum_p(House.Type.class));
